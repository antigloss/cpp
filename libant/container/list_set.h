...
/** @file container/list_set.h
 *  list_set implementation.
 */

#ifndef LIBANT_CONTAINER_LIST_SET_H_
#define LIBANT_CONTAINER_LIST_SET_H_
...
namespace ant {
   ...
   *  retrieved in logarithmic time. The default iteration order
   *  of list_set is insertion-order.
   *
  ...
  template<typename _Key, typename _Compare = std::less<_Key>,
    ...
    private:
      ...
      _Rep_type _M_t;  // Red-black tree representing list_set.
    ...
    public:
       ...
       */
      explicit
      list_set(const _Compare& __comp,
	...
	list_set(_InputIterator __first, _InputIterator __last)
	: _M_t()
	...
	: _M_t(__comp, _Key_alloc_type(__a))
     ...
     /**
       ...
       */
      list_set(std::initializer_list<value_type> __l,
	...
	friend bool
	operator==(const list_set<_K1, _C1, _A1>&, const list_set<_K1, _C1, _A1>&);
  ...
  */
  template<typename _Key, typename _Compare, typename _Alloc>
    inline bool
    operator==(const list_set<_Key, _Compare, _Alloc>& __x,
	       const list_set<_Key, _Compare, _Alloc>& __y)
  ...
  */
  ...
  template<typename _Key, typename _Compare, typename _Alloc>
    inline void
    swap(list_set<_Key, _Compare, _Alloc>& __x, list_set<_Key, _Compare, _Alloc>& __y)
    { __x.swap(__y); }

} //namespace std

#endif /* LIBANT_CONTAINER_LIST_SET_H_ */
