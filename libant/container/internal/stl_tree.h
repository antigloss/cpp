...
/** @file container/internal/stl_tree.h
 *  This is an internal header file, included by other library headers.
 *  Do not attempt to use it directly. @headername{container/linked_set.h}
 */

#ifndef LIBANT_CONTAINER_INTERNAL_STL_TREE_H_
#define LIBANT_CONTAINER_INTERNAL_STL_TREE_H_
...
#define _LIBANT_FORWARD(_Tp, __val) std::forward<_Tp>(__val)
#define _LIBANT_NOEXCEPT noexcept

#else

#define _LIBANT_FORWARD(_Tp, __val) (__val)
#define _LIBANT_NOEXCEPT
...
// associative containers (linked_set, linked_multiset, linked_map,
// and linked_multimap). The insertion and deletion algorithms are
// based on those in Cormen, Leiserson, and Rivest, Introduction to
// Algorithms (MIT Press, 1990), except that
//
...
struct _Rb_tree_const_iterator {
	...
	{
		return iterator(
		        static_cast<typename iterator::_Link_type>(const_cast<typename iterator::_Base_ptr>(_M_node)));
	}
...
protected:
	...
	_Link_type _M_create_node(_Args&&... __args)
	{
		...
		__try
		{
			std::allocator_traits<_Node_allocator>::construct(
			        _M_get_Node_allocator(), __tmp,
...
private:
	...
	std::pair<_Base_ptr, _Base_ptr>
	_M_get_insert_hint_equal_pos(const_iterator __pos, const key_type& __k);
...
public:
	...
	{
		if (__x._M_root() != 0) {
			_M_insert_unique(__x.link_begin(), __x.link_end());
		}
	}
...
_Rb_tree<_Key, _Val, _KeyOfValue, _Compare, _Alloc>::_Rb_tree(_Rb_tree<_Key, _Val, _KeyOfValue, _Compare, _Alloc> && __x)
...
template<typename _Arg>
#endif
typename _Rb_tree<_Key, _Val, _KeyOfValue, _Compare, _Alloc>::iterator _Rb_tree<
...
#endif
{
	...
	return _M_insert_lower(__y, _LIBANT_FORWARD(_Arg, __v));
}
...
template<typename _Key, typename _Val, typename _KeyOfValue, typename _Compare,
        typename _Alloc>
typename _Rb_tree<_Key, _Val, _KeyOfValue, _Compare, _Alloc>::iterator _Rb_tree<
        _Key, _Val, _KeyOfValue, _Compare, _Alloc>::_M_lower_bound(
...
template<typename _Key, typename _Val, typename _KeyOfValue, typename _Compare,
        typename _Alloc>
typename _Rb_tree<_Key, _Val, _KeyOfValue, _Compare, _Alloc>::const_iterator _Rb_tree<
        _Key, _Val, _KeyOfValue, _Compare, _Alloc>::_M_lower_bound(
...
template<typename _Key, typename _Val, typename _KeyOfValue, typename _Compare,
        typename _Alloc>
typename _Rb_tree<_Key, _Val, _KeyOfValue, _Compare, _Alloc>::iterator _Rb_tree<
        _Key, _Val, _KeyOfValue, _Compare, _Alloc>::_M_upper_bound(
        _Link_type __x, _Link_type __y, const _Key& __k)
{
	while (__x != 0)
...
std::pair<
        ...
        typename _Rb_tree<_Key, _Val, _KeyOfValue, _Compare, _Alloc>::iterator> _Rb_tree<
        _Key, _Val, _KeyOfValue, _Compare, _Alloc>::equal_range(const _Key& __k)
{
	_Link_type __x = _M_begin();
	_Link_type __y = _M_end();
	while (__x != 0) {
...
std::pair<
        ...
        typename _Rb_tree<_Key, _Val, _KeyOfValue, _Compare, _Alloc>::const_iterator> _Rb_tree<
        _Key, _Val, _KeyOfValue, _Compare, _Alloc>::equal_range(
...
void _Rb_tree<_Key, _Val, _KeyOfValue, _Compare, _Alloc>::swap(_Rb_tree<_Key, _Val, _KeyOfValue, _Compare, _Alloc>& __t)
{
	if (_M_root() == 0) {
		if (__t._M_root() != 0) {
			...
			_M_root()->_M_parent = _M_end();
			__t._M_impl._M_header._M_prev->_M_next = &(_M_impl._M_header);
			__t._M_impl._M_header._M_next->_M_prev = &(_M_impl._M_header);
			_M_impl._M_header._M_prev = __t._M_impl._M_header._M_prev;
			_M_impl._M_header._M_next = __t._M_impl._M_header._M_next;

			__t._M_root() = 0;
			__t._M_leftmost() = __t._M_end();
			__t._M_rightmost() = __t._M_end();
			__t._M_impl._M_init_list_head();
		}
		...
		_M_impl._M_header._M_prev->_M_next = &(__t._M_impl._M_header);
		_M_impl._M_header._M_next->_M_prev = &(__t._M_impl._M_header);
		__t._M_impl._M_header._M_prev = _M_impl._M_header._M_prev;
		__t._M_impl._M_header._M_next = _M_impl._M_header._M_next;
		...
		std::swap(_M_impl._M_header._M_prev->_M_next, __t._M_impl._M_header._M_prev->_M_next);
		std::swap(_M_impl._M_header._M_next->_M_prev, __t._M_impl._M_header._M_next->_M_prev);
		std::swap(_M_impl._M_header._M_prev, __t._M_impl._M_header._M_prev);
		std::swap(_M_impl._M_header._M_next, __t._M_impl._M_header._M_next);

		_M_root()->_M_parent = _M_end();
		__t._M_root()->_M_parent = __t._M_end();
	}
	// No need to swap header's color as it does not change.
	std::swap(_M_impl._M_node_count, __t._M_impl._M_node_count);
	std::swap(_M_impl._M_key_compare, __t._M_impl._M_key_compare);

	// 431. Swapping containers with unequal allocators.
	std::__alloc_swap<_Node_allocator>::_S_do_it(_M_get_Node_allocator(),
...
std::pair<
        ...
        typename _Rb_tree<_Key, _Val, _KeyOfValue, _Compare, _Alloc>::_Base_ptr> _Rb_tree<
        _Key, _Val, _KeyOfValue, _Compare, _Alloc>::_M_get_insert_unique_pos(
        const key_type& __k)
{
...
std::pair<
        typename _Rb_tree<_Key, _Val, _KeyOfValue, _Compare, _Alloc>::_Base_ptr,
        typename _Rb_tree<_Key, _Val, _KeyOfValue, _Compare, _Alloc>::_Base_ptr> _Rb_tree<
        _Key, _Val, _KeyOfValue, _Compare, _Alloc>::_M_get_insert_equal_pos(
        const key_type& __k)
{
	typedef std::pair<_Base_ptr, _Base_ptr> _Res;
	_Link_type __x = _M_begin();
...
#endif
{
	...
	std::pair<_Base_ptr, _Base_ptr> __res = _M_get_insert_unique_pos(
	        _KeyOfValue()(__v));

	if (__res.second)
		return _Res(
		        _M_insert_(__res.first, __res.second,
		                _LIBANT_FORWARD(_Arg, __v)), true);
...
#endif
{
	std::pair<_Base_ptr, _Base_ptr> __res = _M_get_insert_equal_pos(
	        _KeyOfValue()(__v));
	return _M_insert_(__res.first, __res.second, _LIBANT_FORWARD(_Arg, __v));
}
...
std::pair<
        typename _Rb_tree<_Key, _Val, _KeyOfValue, _Compare, _Alloc>::_Base_ptr,
        typename _Rb_tree<_Key, _Val, _KeyOfValue, _Compare, _Alloc>::_Base_ptr> _Rb_tree<
        _Key, _Val, _KeyOfValue, _Compare, _Alloc>::_M_get_insert_hint_unique_pos(
...
#endif
{
	std::pair<_Base_ptr, _Base_ptr> __res = _M_get_insert_hint_unique_pos(
	        __position, _KeyOfValue()(__v));
...
std::pair<
        typename _Rb_tree<_Key, _Val, _KeyOfValue, _Compare, _Alloc>::_Base_ptr,
        typename _Rb_tree<_Key, _Val, _KeyOfValue, _Compare, _Alloc>::_Base_ptr> _Rb_tree<
        _Key, _Val, _KeyOfValue, _Compare, _Alloc>::_M_get_insert_hint_equal_pos(
        const_iterator __position, const key_type& __k)
{
	iterator __pos = __position._M_const_cast();
	typedef std::pair<_Base_ptr, _Base_ptr> _Res;
...
#endif
{
	std::pair<_Base_ptr, _Base_ptr> __res = _M_get_insert_hint_equal_pos(
	        __position, _KeyOfValue()(__v));

	if (__res.second)
		return _M_insert_(__res.first, __res.second, _LIBANT_FORWARD(_Arg, __v));

	return _M_insert_equal_lower(_LIBANT_FORWARD(_Arg, __v));
}
...
template<typename _Key, typename _Val, typename _KeyOfValue, typename _Compare,
        typename _Alloc>
typename _Rb_tree<_Key, _Val, _KeyOfValue, _Compare, _Alloc>::iterator _Rb_tree<
        _Key, _Val, _KeyOfValue, _Compare, _Alloc>::_M_insert_node(
...
template<typename _Key, typename _Val, typename _KeyOfValue, typename _Compare,
        typename _Alloc>
typename _Rb_tree<_Key, _Val, _KeyOfValue, _Compare, _Alloc>::iterator _Rb_tree<
        _Key, _Val, _KeyOfValue, _Compare, _Alloc>::_M_insert_lower_node(
...
template<typename _Key, typename _Val, typename _KeyOfValue, typename _Compare,
        typename _Alloc>
typename _Rb_tree<_Key, _Val, _KeyOfValue, _Compare, _Alloc>::iterator _Rb_tree<
        _Key, _Val, _KeyOfValue, _Compare, _Alloc>::_M_insert_equal_lower_node(
        _Link_type __z)
{
	_Link_type __x = _M_begin();
	_Link_type __y = _M_end();
...
std::pair<
        typename _Rb_tree<_Key, _Val, _KeyOfValue, _Compare, _Alloc>::iterator,
        bool> _Rb_tree<_Key, _Val, _KeyOfValue, _Compare, _Alloc>::_M_emplace_unique(
        _Args&&... __args)
{
...
template<typename ... _Args>
typename _Rb_tree<_Key, _Val, _KeyOfValue, _Compare, _Alloc>::iterator _Rb_tree<
        _Key, _Val, _KeyOfValue, _Compare, _Alloc>::_M_emplace_equal(
        _Args&&... __args)
{
	_Link_type __z = _M_create_node(std::forward<_Args>(__args)...);
...
template<typename ... _Args>
typename _Rb_tree<_Key, _Val, _KeyOfValue, _Compare, _Alloc>::iterator _Rb_tree<
        _Key, _Val, _KeyOfValue, _Compare, _Alloc>::_M_emplace_hint_unique(
...
template<typename ... _Args>
typename _Rb_tree<_Key, _Val, _KeyOfValue, _Compare, _Alloc>::iterator _Rb_tree<
        _Key, _Val, _KeyOfValue, _Compare, _Alloc>::_M_emplace_hint_equal(
        const_iterator __pos, _Args&&... __args)
{
	_Link_type __z = _M_create_node(std::forward<_Args>(__args)...);
...
template<typename _Key, typename _Val, typename _KeyOfValue, typename _Compare,
        typename _Alloc>
typename _Rb_tree<_Key, _Val, _KeyOfValue, _Compare, _Alloc>::size_type _Rb_tree<
        _Key, _Val, _KeyOfValue, _Compare, _Alloc>::erase(const _Key& __x)
{
...
template<typename _Key, typename _Val, typename _KeyOfValue, typename _Compare,
        typename _Alloc>
typename _Rb_tree<_Key, _Val, _KeyOfValue, _Compare, _Alloc>::iterator _Rb_tree<
        _Key, _Val, _KeyOfValue, _Compare, _Alloc>::find(const _Key& __k)
{
...
template<typename _Key, typename _Val, typename _KeyOfValue, typename _Compare,
        typename _Alloc>
typename _Rb_tree<_Key, _Val, _KeyOfValue, _Compare, _Alloc>::const_iterator _Rb_tree<
        _Key, _Val, _KeyOfValue, _Compare, _Alloc>::find(const _Key& __k) const
{
...
template<typename _Key, typename _Val, typename _KeyOfValue, typename _Compare,
        typename _Alloc>
typename _Rb_tree<_Key, _Val, _KeyOfValue, _Compare, _Alloc>::size_type _Rb_tree<
        _Key, _Val, _KeyOfValue, _Compare, _Alloc>::count(const _Key& __k) const
{
...
#endif /* LIBANT_CONTAINER_INTERNAL_STL_TREE_H_ */
