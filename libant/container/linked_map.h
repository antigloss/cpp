...
/**
 * @file container/linked_map.h
 * @brief linked_map implementation.
 */

#ifndef LIBANT_CONTAINER_LINKED_MAP_H_
#define LIBANT_CONTAINER_LINKED_MAP_H_
...
public:
	class value_compare: public std::binary_function<value_type, value_type, bool> {
		friend class linked_map<_Key, _Tp, _Compare, _Alloc> ;
	protected:
		_Compare comp;
...
public:
	 ...
	 */
	explicit linked_map(const _Compare& __comp, const allocator_type& __a =
	        allocator_type()) :
	 ...
	 */
	linked_map(std::initializer_list<value_type> __l, const _Compare& __comp =
	...
	linked_map(_InputIterator __first, _InputIterator __last) :
			_M_t()
	{
	...
	friend bool
	operator==(const linked_map<_K1, _T1, _C1, _A1>&,
	        const linked_map<_K1, _T1, _C1, _A1>&);
...
inline bool operator==(const linked_map<_Key, _Tp, _Compare, _Alloc>& __x,
        const linked_map<_Key, _Tp, _Compare, _Alloc>& __y)
{
